...
if __name__ == '__main__':
    ...
    weight_path = './weights/model_saved_trace.pt'
    ...
    node_dic = torch.load('./node_dic_list_model_saved_trace_epoch=15_lr=1e-05_weight_decay=0_loss=1')
    total_loss = 0
    for node in node_dic:
        total_loss += node['loss']
    print(f'average loss= {total_loss/len(node_dic)}')
